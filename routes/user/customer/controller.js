...
module.exports = {
    ...
    //         const oldPass = await Customer.findOne({ password })
    //         console.log('««««« oldPass »»»»»', oldPass);

    //         const changeNewPass = await Customer.find({ newPass });

    //         const errors = [];
    //         if (getPassExits && getPassExits.length > 0) errors.push('Mật khẩu mới không đc trùng mật khẩu cũ');
